...
class Upload
{
    ...
    public function __construct($config = array(), $driver = '', $driverConfig = null)
    {
        ...
        $driver = $driver ? $driver : ($this->driver ? $this->driver : config('FILE_UPLOAD_TYPE'));
        $this->driver = $driver;
        $driverConfig = $driverConfig ? $driverConfig : ($this->driverConfig ? $this->driverConfig : config('UPLOAD_TYPE_CONFIG'));
        $this->driverConfig = $driverConfig;
        /* 设置上传驱动 */
        $class = strpos($driver, '\\') ? $driver : '\\think\\upload\\driver\\' . strtolower($driver);
