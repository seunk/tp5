...
define('UC_AUTH_KEY', 'upLlP8kbTivCjaHoUF1wD9qOgVIMWAY74mSJX5n3'); //加密KEY
...
define('BACKSTAGE_MODULE', "backstage");//重新定义后台模块


if (file_exists(CMS_ROOT . "data/conf/config.php")) {
    $runtimeConfig = include CMS_ROOT . "data/conf/config.php";
} else {
    $runtimeConfig = [];
}
...
$configs = [
    ...
    // 注册的根命名空间
    'root_namespace'         => ['addons'=>ONETHINK_ADDON_PATH],
    // 扩展函数文件
    ...
    'template'               => [
        ...
        // 标签库标签结束标记
        'taglib_end'   => '>',
        'taglib_build_in' => 'app\common\taglib\Think,cx',
    ],
    ...
    'admin_default_template' => 'admin_default',

    /* 系统数据加密设置 */
    'data_auth_key' => 'upLlP8kbTivCjaHoUF1wD9qOgVIMWAY74mSJX5n3', //默认数据加密KEY
];
